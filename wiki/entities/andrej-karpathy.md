...
## Кто это
Исследователь ИИ, сооснователь OpenAI, бывший директор по ИИ в Tesla, сейчас фаундер Eureka Labs. В контексте этой вики упоминается как автор оригинального гиста/твита ("Karpathy's original Gist"), от которого отталкивается [[karpathy-jarvis-personal-ai-memory|метод построения персональной AI-памяти]] через Claude Code + Obsidian. По утверждению [[ii-mastodont]], его пост об этой идее собрал 18 млн просмотров за неделю.
