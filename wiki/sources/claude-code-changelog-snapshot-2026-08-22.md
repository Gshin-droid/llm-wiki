...
**Дополнение (2026-09-21):** первый практический разбор Admin API — [[claude-cookbook-admin-api]], новая сущность [[claude-admin-api]]. До этого разбора факт «вышла из беты» так и оставался голой строкой без единого примера кода.
