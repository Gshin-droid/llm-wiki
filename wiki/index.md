...
- [[delegirovanie-deshevym-modelyam]] — что сгружать дешёвым моделям и как проверять: лестница исполнителей, каскад с оценщиком качества, замеры на пяти материалах, разбор готовых решений (LiteLLM, `llm`, агрегаторы)
