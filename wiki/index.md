...
- [[pochemu-klaviatura-vesit-malo]] — почему клавиатура на телефоне весит мало, а веса диктовки — сотни мегабайт: модели в клавиатуре нет вовсе, у Google 80 МБ на язык против наших 216 МБ, и что из приёмов сжатия к нам применимо, а что нет
