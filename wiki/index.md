...
- [[asr-benchmark-traps]] — три способа, которыми замер модели распознавания речи врёт, все три пойманы на своём замере: эталон входит в обучающую выборку (3,9 % вместо 5,9 %), эталон требует символов, которых нет в алфавите модели (10,09 % вместо 7,11 %), жанр материала не тот (25 % вместо 79 %); почему «сколько сломали» важнее «сколько починили» и как мерить надстройку без звука
...
- [[dictum-golosovaya-diktovka]] — своя голосовая диктовка для Windows: знаки препинания разметочной моделью, а не языковой (слова менять не умеет по устройству), две проверки текста вместо одной, дефисы поимённым списком вместо правила по суффиксу, словарь замен под ведение человеком; замеры вместо ощущений
